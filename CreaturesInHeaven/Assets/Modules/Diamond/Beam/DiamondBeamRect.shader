...
Shader "Diamond/BeamRect"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // (_Color/_ZoomX/Z/_Focus/_BeamIntensity). No multi_compile variant, so nothing has
            // to toggle sticky material-asset state; the manager just sets one global at Start.
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                // and stashed in the v2f, so these are flat v2f reads here. Static props (cube
                // scale, emitter size) always come from the buffer.
