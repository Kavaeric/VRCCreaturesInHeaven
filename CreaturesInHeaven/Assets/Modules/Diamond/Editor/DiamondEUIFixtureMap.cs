...
public class DiamondEUIFixtureMap : EditorWindow
{
    // --- Data --------------------------------------------------------
    ...
    {
        foreach (var guid in AssetDatabase.FindAssets($"t:MonoScript {nameof(DiamondEUIFixtureMap)}"))
        {
            string path = AssetDatabase.GUIDToAssetPath(guid);
            if (path.EndsWith($"{nameof(DiamondEUIFixtureMap)}.cs"))
    ...
    private static void Open() => GetWindow<DiamondEUIFixtureMap>("Fixture map");
