...
namespace VRCLightVolumes {
    ...
    // Patch (PR #84): selects how the atlas packer trades off VRAM vs depth.
    // MinimumDepth is preferred when a post-processor CRT is in the chain, since
    // CRT updates dispatch one drawcall per Z slice. See PATCHES.md at repo root.
